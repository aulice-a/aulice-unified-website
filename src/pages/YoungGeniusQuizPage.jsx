// src/pages/YoungGeniusQuizPage.jsx
...
const PageStyles = () => (
    <style dangerouslySetInnerHTML={{ __html: `
        ...
        button:focus {
            ...
            --tw-ring-color: #a855f7; /* ring-purple-500 for share button */
...
const questions = [
    ...
    { question: "Which planet is known as the Red Planet?", answers: ["Jupiter", "Mars", "Venus", "Saturn"], correct: "Mars" },
    { question: "What is the largest ocean on Earth?", answers: ["Atlantic Ocean", "Indian Ocean", "Pacific Ocean", "Arctic Ocean"], correct: "Pacific Ocean" },
    { question: "What is the largest land animal?", answers: ["African Elephant", "Giraffe", "Blue Whale", "Polar Bear"], correct: "African Elephant" },
    { question: "What is the smallest country in the world?", answers: ["Monaco", "Nauru", "Vatican City", "San Marino"], correct: "Vatican City" }
];

// --- Main Component ---
function YoungGeniusQuizPage() {
    const [currentScreen, setCurrentScreen] = useState('welcome'); // 'welcome', 'quiz', 'results'
    const [currentQuestionIndex, setCurrentQuestionIndex] = useState(0);
    const [score, setScore] = useState(0);
    const [feedback, setFeedback] = useState('');
    const [selectedAnswer, setSelectedAnswer] = useState(null); // To track which answer was clicked
    ...
    const handleAnswerSelect = (selected, correct) => {
        ...
        setSelectedAnswer(selected); // Store selected answer text
    ...
    return (
        <div className="flex flex-col items-center min-h-screen bg-gray-100 p-4 w-full"> {/* Ensure root div takes full width */}
            <PageStyles />
            ...
            <div id="quiz-container" className="bg-white p-8 rounded-2xl shadow-xl max-w-lg w-full text-center">
                ...
                {currentScreen === 'welcome' && (
                    <div id="welcome-screen" className="space-y-6">
                        ...
                        <p className="text-lg text-gray-600">Think you know it all? Let's find out!</p>
                            ...
                            {currentQuestion.answers.map((answer, index) => {
                                ...
                                if (selectedAnswer !== null) {
                                    if (answer === currentQuestion.correct) {
                                        ...
                                        buttonClass += ' opacity-50 cursor-not-allowed'; // Dim unselected, incorrect answers
                                    }
                                }
                                return (
                                    <button
...
export default YoungGeniusQuizPage;